...
# @see https://github.com/franckverrot/activevalidators/blob/master/lib/active_validators/active_model/validations/url_validator.rb
#
...
class UrlValidator < ActiveModel::EachValidator
  ...
  # Returns the Regexp.
  def uri_regexp
    @uri_regexp ||= /\A#{URI::DEFAULT_PARSER.make_regexp(protocols)}\z/
  end
